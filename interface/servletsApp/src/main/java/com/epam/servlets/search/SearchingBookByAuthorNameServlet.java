...
@WebServlet("/search/searchBookByAuthorName")
public class SearchingBookByAuthorNameServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            request.getSession().setAttribute("bookList", bookService.searchBooksByPartOfAuthorName(authorName));
