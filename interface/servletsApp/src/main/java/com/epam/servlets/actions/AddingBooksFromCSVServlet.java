...
import com.epam.library.business.CSVParser;
...
@WebServlet("/actions/addBooksFromCSV")
public class AddingBooksFromCSVServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException {
        ...
        try {
            bookService.addBooksFromList(parser.parse(httpServletRequest.getParameter("csv_file")));
